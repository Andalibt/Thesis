...
% ~(uncorrelated with the electric field $E$),
...
gradient~(see section~\ref{sec:comag}). The $^{199}$Hg false EDM is
larger than for the neutrons because of its larger~(thermal) velocity.
Graphing the measured neutron EDM as a function of this ratio then
allows to correct to the zero gradient and hence discover the true
neutron EDM. This is also supplemented by gradient determination using
surrounding Cs magnetometers~\cite{afach2015measurement}.

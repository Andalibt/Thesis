...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%You can add stuff here using Florian's thesis
...
\subsubsection{UCN Production Rate with Single Phonon scattering in Superfluid helium~\cite{Korobkina2002,Schmidt2009,Golub77}\label{sec:UCN_production}}

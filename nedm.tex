...
% The moderators and the He-II cryostat are surrounded by shielding
% blocks made of steel. Additionally, neutron absorbers made of
% borated polyethylene~(PE) line the moderators and the UCN guide to
% reduce activation of the steel blocks by thermal neutrons. Including
% a 10~cm of steel shielding and 5~cm of borated polyethylene,
% significantly reduces the activation of the cryostat in cases with
% large shielding penetrations.

The heavy-water moderator at room temperature is a thermal
pre-moderator for fast neutrons.
%reducing the required amount of cold
...
The new UCN source will have several key improvements. Foremost of
...
The second parameter is the roughness of the surface. Transport
...
supplies,
% , with a readily achievable stability of $10^{-3}$,
...
coils
%This resulted in three summer student
%projects and an Honours thesis
~\cite{Rosie_thesis}.


To summarize, in principle, by utilizing both active and passive
...
%candidates because of their high optical potential , small absorption

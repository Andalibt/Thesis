...
to calculate the diffuse scattering distribution of the UCN impinging
on the material surface: Lambert model or the Microroughness
model.
% ~\cite{Steyerl1972}.
...
the detector~(see Section~\ref{sec:vertical_source} for more details).

The absorption in the foil is set according to the measurements

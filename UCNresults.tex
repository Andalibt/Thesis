...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{UCNCounts_vs_Temperature_color.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{Storagelifetime_vs_Temp_color.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{rate_vs_Temp_col.pdf}
  \caption{Histogram of measured UCN rates and temperatures from all
    four temperature sensors while the target is continuously

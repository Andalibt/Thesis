...
For better understanding the loss mechanisms the experiment was also
simulated in PENTrack~\cite{schreyer2017pentrack}. PENTrack is a
...
Chapter one, UCN interacts with all four fundamental forces. To
...
part of, $W$, depends on the loss cross-section for a given velocity.
...
Lambert model or the Microroughness.
